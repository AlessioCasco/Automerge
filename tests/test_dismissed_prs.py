...
class TestDismissedPRs(unittest.TestCase):
    ...
    @patch("requests.post")
    def test_process_dismissed_pr_with_no_changes(
        self, mock_post, mock_get_last_comment, mock_merge
    ):
    ...
    @patch.object(GitHubClient, "get_last_comment")
    @patch("requests.post")
    def test_process_dismissed_pr_with_changes(
        self, mock_post, mock_get_last_comment, mock_merge
    ):
    ...
    @patch.object(GitHubClient, "get_last_comment")
    @patch("requests.post")
    def test_process_dismissed_pr_with_no_comments(
        self, mock_post, mock_get_last_comment, mock_merge
    ):
    ...
    def test_is_approved_handles_stale_approval(self, mock_put, mock_post, mock_get):
        ...
        pr = {"number": 126, "url": "https://api.github.com/repos/owner/repo/pulls/126"}
